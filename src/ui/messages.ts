const messages = {
  ...
  processRoverDirections: {
    addNewRover:
      "Valid co-ordinates received. For the next rover, please enter: \n- the starting co-ordinates.",
    failure: (reason: string) =>
      `Rover instructions ${reason}. \nPlease try inputting directions again.`,
  },
